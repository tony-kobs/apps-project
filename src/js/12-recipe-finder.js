...
const mealDetailsContent = document.querySelector('.meal-detailes-content');
  ...
  try {
    ...
    if (data.meals && data.meals[0]) {
      ...
      mealDetailsContent.innerHTML = `
        <img src="${meal.strMealThumb}" alt="${meal.strMeal}" class="meal-detailes-img">
        <h2 class="meal-detailes-title">${meal.strMeal}</h2>
